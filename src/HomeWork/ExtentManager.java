...
public class ExtentManager
{
    ...
    public static String filePath = "C:\\Users\\sarit_2\\Desktop\\Automation\\Selenium\\Reports\\"+reportDate+"\\exReport.html";

    //יצירת דוח report
    public static ExtentReports GetExtent()
    {
        new File("C:\\Users\\sarit_2\\Desktop\\Automation\\Selenium\\Reports\\" + reportDate).mkdirs();
        if (extent != null)
    ...
    public static String CaptureScreen(WebDriver driver) throws AWTException, IOException{
        ...
        String folderPath = ("C:\\Users\\sarit_2\\Desktop\\Automation\\Selenium\\Reports\\"+reportDate);
